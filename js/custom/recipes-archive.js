...
$(document).ready(function(){
	...
	$('.recipes_slider_actual_container').slick({
		prevArrow: '<button type="button" class="slick-prev"><img src="/wp-content/themes/caciquedilla/assets/img/home/left-arrow.png"></button>',
		nextArrow: '<button type="button" class="slick-next"><img src="/wp-content/themes/caciquedilla/assets/img/home/right-arrow.png"></button>',
		dots: true
	});
